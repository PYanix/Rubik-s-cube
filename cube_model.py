...
class Cube:
    def __init__(self, dim: int):
        ...
        self.R_colors = [['y' for _ in range(self.dim)] for _ in range(self.dim)]  # R - right face of the cube
        self.L_colors = [['w' for _ in range(self.dim)] for _ in range(self.dim)]  # L - left face of the cube
        self.U_colors = [['b' for _ in range(self.dim)] for _ in range(self.dim)]  # U - upper face of the cube
        self.D_colors = [['g' for _ in range(self.dim)] for _ in range(self.dim)]  # D - down face of the cube
